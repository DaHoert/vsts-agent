    ...
    public abstract class GitSourceProvider : ISourceProvider
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (!string.IsNullOrEmpty(submoduleInput))
            {
                ...
                if (string.Equals(submoduleInput, Pipelines.PipelineConstants.CheckoutTaskInputs.SubmodulesOptions.All, StringComparison.OrdinalIgnoreCase))
                {
            ...
            bool exposeCred = StringUtil.ConvertToBoolean(executionContext.GetInput(Pipelines.PipelineConstants.CheckoutTaskInputs.PreserveCred));
